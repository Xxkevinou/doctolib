...
ActiveRecord::Schema.define(version: 2018_10_25_173706) do

  create_table "appos", force: :cascade do |t|
    t.datetime "datetime"
    ...
    t.integer "city_id"
    t.index ["city_id"], name: "index_appos_on_city_id"
    t.index ["doctors_id"], name: "index_appos_on_doctors_id"
    t.index ["patients_id"], name: "index_appos_on_patients_id"
  end
